...
class Post(models.Model):
    ...
    content = RichTextField(verbose_name='İçerik')                # uzun metinler için textfield kullanıyoruz.
    ...
    def get_unique_slug(self):
        ...
        while Post.objects.filter(slug=unique_slug).exists():
            unique_slug = '{0}-{1}'.format(slug,counter)
            counter += 1
        return unique_slug
...
class Comment(models.Model):
    ...
    post = models.ForeignKey('EnsPost.Post', related_name='comments', on_delete=models.CASCADE)
